...
private val NO_CONNECTION_ERROR = App.instanceApp.getString(R.string.error_connection)
private val NO_RESPONSE_TIMEOUT = App.instanceApp.getString(R.string.error_response_timeout)
private val NO_INTERNET_CONNECTION = App.instanceApp.getString(R.string.no_internet_connection)
...
private fun showSnackbar(view: View, @StringRes errorMessage: Int, error: String,
                         @StringRes actionLabel: Int, clickListener: View.OnClickListener?): Snackbar {
    val errorMessageString = App.instanceApp.getString(errorMessage)
