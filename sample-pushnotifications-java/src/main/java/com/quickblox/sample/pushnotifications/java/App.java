...
public class App extends Application {
    ...
    public static final String USER_LOGIN = "test_user_id2";
    public static final String USER_PASSWORD = "test_user_id2";
    ...
    private void checkConfig() {
        if (TextUtils.isEmpty(APPLICATION_ID) || TextUtils.isEmpty(AUTH_KEY) || TextUtils.isEmpty(AUTH_SECRET) || TextUtils.isEmpty(ACCOUNT_KEY)
                || TextUtils.isEmpty(USER_LOGIN) || TextUtils.isEmpty(USER_PASSWORD)) {
