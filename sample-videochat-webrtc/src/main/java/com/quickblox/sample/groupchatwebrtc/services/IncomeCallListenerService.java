...
public class IncomeCallListenerService extends Service implements QBRTCClientSessionCallbacks, QBRTCSessionConnectionCallbacks {
    ...
    public void onDestroy() {
        ...
        SessionManager.getCurrentSession().removeSessionnCallbacksListener(this);
    ...
    private void reloginToChat(final String login, final String password) {
        QBAuth.createSession(login, password, new QBEntityCallbackImpl<QBSession>() {
            @Override
            public void onSuccess(QBSession session, Bundle bundle) {
                Log.d(TAG, "onSuccess create session with params");
    ...
    private void startOpponentsActivity(){
        if (startServiceVariant != Consts.AUTOSTART) {
            Intent intent = new Intent(IncomeCallListenerService.this, CallActivity.class);
    ...
    private void initQBRTCClient() {
        ...
        QBRTCClient.getInstance(IncomeCallListenerService.this).setCameraErrorHendler(new VideoCapturerAndroid.CameraErrorHandler() {
            @Override
    ...
    public void onCallAcceptByUser(QBRTCSession qbrtcSession, Integer integer, Map<String, String> map) {
        sendBroadcastMessages(Consts.CALL_ACCEPT_BY_USER, integer, map, null);
    }
    ...
    public void onUserNoActions(QBRTCSession qbrtcSession, Integer integer) {
        sendBroadcastMessages(Consts.CALL_NO_ACTIONS, integer, null, null);
    }
