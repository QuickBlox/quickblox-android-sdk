...
import com.quickblox.sample.videochat.conference.kotlin.BuildConfig
...
class AppInfoActivity : AppCompatActivity() {
    ...
    private lateinit var janusServerTextView: TextView
    ...
    private fun initUI() {
        ...
        janusServerTextView = findViewById(R.id.text_janus_server)
    ...
    private fun fillUI() {
        ...
        janusServerTextView.text = ConferenceConfig.getUrl()
