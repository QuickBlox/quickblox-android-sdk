...
public class SnippetsUsers extends Snippets{
    ...
    Snippet signInUsingTwitterDigitsSynchronous = new AsyncSnippet("sign in user (synchronous)", "with Twitter Digits", context) {
        @Override
        public void executeAsync() {
            initTwitterDigits();
...
//            user.setFileId(-1);
    ...
    Snippet getUsersWithTwitterDigitsIDsSynchronous = new AsyncSnippet("get users (synchronous)", "with twitter digits IDs", context) {
        @Override
        public void executeAsync() {
            ArrayList<String> twitterDigitsIDs = new ArrayList<String>();
            twitterDigitsIDs.add("3533173695");
...
//            userTags.add("car");
    ...
    Snippet getUserWithTwitterDigitsIdSynchronous = new AsyncSnippet("get user (synchronous)", "with twitter digits id", context) {
        @Override
        public void executeAsync() {
            String twitterDigitsId = "3533173695";
